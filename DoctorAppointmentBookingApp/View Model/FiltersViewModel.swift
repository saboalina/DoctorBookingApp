...
//    func getAvailableDoctorsTest(startDate: Date, endDate: Date) -> [Doctor]{
//        let weekDays = getWeekDaysList(startDate: startDate, endDate: endDate)
//        let uniqueWeekDays = getUniqueValues(list: weekDays)
//
...
//
//        var doctorsListForTest = [Doctor]()
//        doctorsListForTest.append(doctor1)
//        doctorsListForTest.append(doctor2)
//        doctorsListForTest.append(doctor3)
//        doctorsListForTest.append(doctor4)
//        doctorsListForTest.append(doctor5)
//
//        var availableDoctors  = doctorsListForTest
//        var availableDoctorsOnMon: [Doctor] = []
//        var availableDoctorsOnTue: [Doctor] = []
//        var availableDoctorsOnWed: [Doctor] = []
//        var availableDoctorsOnThu: [Doctor] = []
